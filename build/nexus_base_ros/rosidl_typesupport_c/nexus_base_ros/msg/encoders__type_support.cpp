...
static const _Encoders_type_support_symbol_names_t _Encoders_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nexus_base_ros, msg, Encoders)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nexus_base_ros, msg, Encoders)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nexus_base_ros, msg, Encoders)() {
  return &::nexus_base_ros::msg::rosidl_typesupport_c::Encoders_message_type_support_handle;
}
