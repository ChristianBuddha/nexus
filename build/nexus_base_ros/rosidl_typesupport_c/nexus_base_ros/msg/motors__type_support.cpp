...
static const _Motors_type_support_symbol_names_t _Motors_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nexus_base_ros, msg, Motors)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nexus_base_ros, msg, Motors)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nexus_base_ros, msg, Motors)() {
  return &::nexus_base_ros::msg::rosidl_typesupport_c::Motors_message_type_support_handle;
}
