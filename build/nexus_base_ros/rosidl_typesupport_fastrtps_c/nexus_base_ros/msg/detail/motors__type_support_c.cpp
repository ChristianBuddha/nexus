...
#include "nexus_base_ros/msg/detail/motors__rosidl_typesupport_fastrtps_c.h"
...
using _Motors__ros_msg_type = nexus_base_ros__msg__Motors;
...
size_t get_serialized_size_nexus_base_ros__msg__Motors(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Motors__ros_msg_type * ros_message = static_cast<const _Motors__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name motor0
  {
    size_t item_size = sizeof(ros_message->motor0);
...
static uint32_t _Motors__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_nexus_base_ros__msg__Motors(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nexus_base_ros
size_t max_serialized_size_nexus_base_ros__msg__Motors(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nexus_base_ros__msg__Motors;
    is_plain =
      (
      offsetof(DataType, motor3) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Motors__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_nexus_base_ros__msg__Motors(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nexus_base_ros, msg, Motors)() {
